<template>
  <div>
    <x-button @click="showScrollBox = true">showScrollBox</x-button>
    ...
    <x-mask
      v-if="showScrollBox"
      :show="true"
      @maskClick="showScrollBox = false"
    >
      <div style="width: 100%;height: 200px;background: #fff;padding: 15px;">
        <x-scroll-box>
          <div style="word-break: break-all;">
            
            ...
            
            2121321212132121213212121321212132121213212121321212132121
          </div>
        </x-scroll-box>
      </div>
    </x-mask>
    ...
    <x-countdown :start="start">
      <template slot-scope="props">
        <div v-if="start && !props.isFinish">{{ props.currentTime }}</div>
        <div v-else @click="start = true">结束</div>
      </template>
    </x-countdown>
    <!--  <swiper :interval="1500" :current="2">
           <swiper-item v-for="(item, index) in options" :key="index">
             <div style="height: 100px;">{{item.label}}</div>
           </swiper-item>
         </swiper> -->
    <x-checker v-model="file"
      >啊实打实大师ad阿萨德啊实打实大师ad阿萨德啊实</x-checker
    >
    ...
    <div @click="show" class="test" @touchstart="() => {}" ref="test">
      12123123323
    </div>
    <abbr title="123dfsdfsds">www</abbr>
    <kbd>quit</kbd>
    <sup @click="show"> 标签和其结束标签 </sup>
    <!-- <div style="height: 600px;"></div> -->
    <!-- <div>
          <div>
            <div>
              <button class="qwer">所发生的</button>
            </div>
          </div>
        </div> -->
  </div>
...
// import XButton from 'src/components/button'
import XTextarea from '@/components/textarea'
import XImageChoice from '@/components/image-choice'
import XInput from '@/components/input'
import XRadio from '@/components/radio'
import XCheckbox from '@/components/checkbox'
import XChecker from '@/components/checker'
import XCountdown from '@/components/countdown'
import XDialog from '@/components/dialog'
import XScrollBox from '@/components/scroll-box'
import XMask from '@/components/mask'
...
export default {
  ...
  mounted() {
    // this.$refs.test.addEventListener('touchstart', () => {})
  },
