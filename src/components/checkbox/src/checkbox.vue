<template>
  <div class="c-checkbox">
    <div
      ...
      :class="{ 'c-checkbox__item--checked': checked }"
...
<script>
import { not, filter, map, indexOf, gt, prop, compose } from 'ramda'
  ...
  computed: {
    _options() {
      ...
      return map(
        e => ({
          ...e,
          checked: gt(indexOf(prop('value', e), this.innerValue), -1)
        }),
        this.options
      )
    }
